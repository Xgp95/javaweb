    ...
    <script type="text/javascript">
        $(function () {
            $("button.addToCart").click(function () {
                ...
                <%--location.href = "${ basePath }cartServlet?action=addItems&id=" + bookId;--%>
                $.getJSON("${ basePath }cartServlet?action=ajaxAddItems&id=" + bookId, function (data) {
                    $("#totalCount").text("您的购物车中有 " + data.totalCount + " 件商品");
                    $("#lastName").html("您刚刚将<span style=\"color: red\">" + data.lastName + "</span>加入到了购物车中");
                })
            })
        })
    </script>
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            ...
            <c:if test="${ empty sessionScope.cart.items }">
                ...
                <div id="lastName" >
                    <span style="color: red">您的购物车空，请选择商品</span>
                </div>
            </c:if>
